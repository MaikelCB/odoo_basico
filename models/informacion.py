...
class informacion(models.Model):
    ...
    mes_frances = fields.Char(compute="_mes_frances", string="Mes en francés", size=15, store=True)
    ...
    def envio_email(self):
        ...
        mail_para = 'braisiessg@gmail.com'  # o enderezo email de destino
        mail_valores = {
    ...
    def _mes_ingles(self):
        ...
        locale.setlocale(locale.LC_TIME,
                         miñasUtilidades.cadeaTextoSegunPlataforma('English_Australia.1252', 'en_GB.utf8'))
        for rexistro in self:
